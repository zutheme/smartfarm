            ...
            <div class="c-navbar-wrapper clearfix">
                ...
                <div class="c-brand c-pull-left">
                    ...
                    <a href="{{ url('/') }}" class="c-logo">
                        ...
                        <img src="{{ asset('assets-tea/images/logo/logo-smart-farm.png') }}" alt="JANGO" class="c-desktop-logo">

                        <img src="{{ asset('assets-tea/images/logo/logo-smart-farm.png') }}" alt="JANGO" class="c-desktop-logo-inverse">

                        <img src="{{ asset('assets-tea/images/logo/logo-smart-farm.png') }}" alt="JANGO" class="c-mobile-logo">
